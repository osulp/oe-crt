...
export class DataTileComponent implements OnInit, OnDestroy, OnChanges {
    ...
    initMapChart() {
        ...
        var series = {
            ...
            states: {
                ...
                select: {
                    color: '#BADA55' // : 'red' //  this.getSelectColor(this),//; '#BADA55'
                    //borderColor: isTextData ? 'black' : null
                }
            },
            //point:
            //{
            //    events: {
            //        select: function () {
            //            console.log('what up bitch', this.selected,this.color);
            //            if (!this.selected) {
    ...
    processDataYear() {
        ...
        if (this.isCustomChart) {
            ...
            this.placeTypeData = this.getPlaceTypeData();  //this.dataStore[this.pluralize(this.selectedPlaceType)].indicatorData[this.indicator].crt_db;
