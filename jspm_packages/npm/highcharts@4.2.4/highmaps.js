...
(function(process) {
  (function(D, U) {
    typeof module === "object" && module.exports ? module.exports = D.document ? U(D) : U : D.Highcharts = U(D);
      ...
      for (var c = "{",
        ...
        if (d) {
          ...
          for (h = 0; h < i; h++)
            e = e[g[h]];
          if (f.length)
            f = f.join(":"), g = /\.([0-9])/, h = J.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = u.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Ma(f, e);
        }
        k.push(e);
        a = a.slice(c + 1);
        c = (d = !d) ? "}" : "{";
    ...
    var x,
        ...
        ob = N.PI,
        ja = ob * 2 / 360,
        xa = D.navigator && D.navigator.userAgent || "",
        Fb = D.opera,
        va = /(msie|trident|edge)/i.test(xa) && !Fb,
        eb = B && B.documentMode === 8,
        fb = !va && /AppleWebKit/.test(xa),
        Ia = /Firefox/.test(xa),
        Gb = /(Mobile|Android|Windows Phone)/.test(xa),
        Da = "http://www.w3.org/2000/svg",
        da = B && B.createElementNS && !!B.createElementNS(Da, "svg").createSVGRect,
        Mb = Ia && parseInt(xa.split("Firefox/")[1], 10) < 4,
        ka = B && !da && !va && !!B.createElement("canvas").getContext,
        Qa,
        Va,
        Hb = {},
        pb = 0,
        ...
        Ha = "div",
        Nb = /^[0-9]+$/,
        hb = ["plotTop", "marginRight", "marginBottom", "plotLeft"],
        wa,
        wb,
        kb,
        xb,
        ...
        if (e() && Ea.push(e) === 1)
          e.timerId = setInterval(function() {
            for (f = 0; f < Ea.length; f++)
              Ea[f]() || Ea.splice(f--, 1);
            Ea.length || clearInterval(e.timerId);
          }, 13);
      },
      step: function(a) {
        var b = +new wa,
    ...
    Ma = function(a, b, c) {
      if (!s(b) || isNaN(b))
        return J.lang.invalidDate || "";
      var a = o(a, "%Y-%m-%d %H:%M:%S"),
          d = new wa(b - (kb && kb(b) || wb || 0) * 6E4),
          e,
          f = d[yb](),
          g = d[zb](),
          h = d[lb](),
    ...
    la = function(a, b) {
      var c;
      if (b === "width")
        return Math.min(a.offsetWidth, a.scrollWidth) - la(a, "padding-left") - la(a, "padding-right");
      else if (b === "height")
        return Math.min(a.offsetHeight, a.scrollHeight) - la(a, "padding-top") - la(a, "padding-bottom");
      return (c = D.getComputedStyle(a, void 0)) && z(c.getPropertyValue(b));
    };
    ya = function(a, b) {
    ...
    X = function(a, b, c) {
      ...
      var f,
          ...
          h;
      if (g)
        b ? (f = g[b] || [], c ? (h = ya(c, f), h > -1 && (f.splice(h, 1), g[b] = f), d(b, c)) : (e(), g[b] = [])) : (e(), a.hcEvents = {});
    };
    M = function(a, b, c, d) {
      var e;
      e = a.hcEvents;
      ...
      if (B.createEvent && (a.dispatchEvent || a.fireEvent))
        e = B.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, r(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e);
      else if (e) {
        e = e[b] || [];
        f = e.length;
        if (!c.preventDefault)
    ...
    Sa = function(a, b, c) {
      ...
      c.curAnim = A(b);
      for (h in b)
        g = new jb(a, c, h), f = null, h === "d" ? (g.paths = g.initPath(a, a.d, b.d), g.toD = b.d, d = 0, f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(la(a, h)) || 0, h !== "opacity" && (e = "px")), f || (f = b[h]), f.match && f.match("px") && (f = f.replace(/px/g, "")), g.run(d, f, e);
    };
    if (D.jQuery)
      D.jQuery.fn.highcharts = function() {
        var a = [].slice.call(arguments);
        if (this[0])
          return a[0] ? (new (u[ta(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : P[L(this[0], "data-highcharts-chart")];
      };
    B && !B.defaultView && (la = function(a, b) {
      var c;
      c = {
        width: "clientWidth",
        height: "clientHeight"
      ...
      b === "opacity" && (b = "filter");
      if (c)
        return a.style.zoom = 1, Math.max(a[c] - 2 * la(a, "padding"), 0);
    ...
    Array.prototype.indexOf || (ya = function(a, b) {
      var c,
          d = 0;
      if (b)
    ...
    O.prototype = {
      parsers: [{
        ...
        parse: function(a) {
          return [z(a[1], 16), z(a[2], 16), z(a[3], 16), 1];
        }
      }, {
      ...
      init: function(a) {
        ...
        if ((this.input = a) && a.stops)
          this.stops = Fa(a.stops, function(a) {
            return new O(a[1]);
          });
        else
      ...
      get: function(a) {
        var b = this.input,
            c = this.rgba,
            d;
        this.stops ? (d = A(b), d.stops = [].concat(d.stops), n(this.stops, function(b, c) {
      ...
      brighten: function(a) {
        ...
        if (this.stops)
          ...
          for (b = 0; b < 3; b++)
            c[b] += z(a * 255), c[b] < 0 && (c[b] = 0), c[b] > 255 && (c[b] = 255);
        return this;
      },
    ...
    K.prototype = {
      ...
      init: function(a, b) {
        this.element = b === "span" ? ca(b) : B.createElementNS(Da, b);
        this.renderer = a;
      },
      ...
      colorGradient: function(a, b, c) {
        ...
        if (f) {
          ...
          f === "radialGradient" && p && !s(g.gradientUnits) && (h = g, g = A(g, d.getRadialAttr(p, h), {gradientUnits: "userSpaceOnUse"}));
          for (q in g)
            q !== "id" && t.push(q, g[q]);
          for (q in j)
            t.push(j[q]);
          t = t.join(",");
          i[t] ? p = i[t].attr("id") : (g.id = p = "highcharts-" + pb++, i[t] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [], n(j, function(a) {
            a[1].indexOf("rgba") === 0 ? (e = O(a[1]), l = e.get("rgb"), m = e.get("a")) : (l = a[1], m = 1);
      ...
      css: function(a) {
        ...
        if (b)
          for (f in a)
            a[f] !== b[f] && (c[f] = a[f], e = !0);
        if (e) {
          e = this.textWidth = a && a.width && d.nodeName.toLowerCase() === "text" && z(a.width) || this.textWidth;
          b && (a = r(b, c));
          this.styles = a;
      ...
      on: function(a, b) {
        var c = this,
            d = c.element;
        Va && a === "click" ? (d.ontouchstart = function(a) {
          c.touchEventFired = wa.now();
          a.preventDefault();
          b.call(d, a);
        }, d.onclick = function(a) {
          (xa.indexOf("Android") === -1 || wa.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a);
        }) : d["on" + a] = b;
        return this;
      },
      ...
      align: function(a, b, c) {
        ...
        f = e.alignedObjects;
        if (a) {
          if (this.alignOptions = a, this.alignByTranslate = b, !c || ta(c))
            this.alignTo = d = c || "renderer", ua(f, this), f.push(this), c = null;
        } else
      ...
      getBBox: function(a, b) {
        ...
        f = o(b, this.rotation);
        g = f * ja;
        e !== x && (q = ["", f || 0, i && i.fontSize, h.style.width].join(","), q = e === "" || Nb.test(e) ? "num:" + e.toString().length + q : e + q);
        q && !a && (c = m[q]);
        if (!c) {
          if (h.namespaceURI === Da || d.forExport) {
            try {
              l = this.fakeTS && function(a) {
                n(h.querySelectorAll(".highcharts-text-shadow"), function(b) {
                  b.style.display = a;
                });
              }, Ia && j.textShadow ? (k = j.textShadow, j.textShadow = "") : l && l("none"), c = h.getBBox ? r({}, h.getBBox()) : {
                width: h.offsetWidth,
          ...
          if (d.isSVG) {
            d = c.width;
            e = c.height;
            if (va && i && i.fontSize === "11px" && e.toPrecision(3) === "16.9")
              c.height = e = 14;
            if (f)
              c.width = S(e * oa(g)) + S(d * ia(g)), c.height = S(e * ia(g)) + S(d * oa(g));
          }
          if (q) {
            for (; p.length > 250; )
              delete m[p.shift()];
      ...
      shadow: function(a, b, c) {
        ...
        if (a) {
          ...
          for (e = 1; e <= i; e++) {
            ...
            if (c)
              L(f, "height", v(L(f, "height") - h, 0)), f.cutHeight = h;
      ...
      titleSetter: function(a) {
        ...
        b || (b = B.createElementNS(Da, "title"), this.element.appendChild(b));
      ...
      zIndexSetter: function(a, b) {
        ...
        if (e) {
          ...
          for (i = 0; i < d.length && !h; i++)
            if (e = d[i], f = e.zIndex, e !== g && (z(f) > a || !s(a) && s(f)))
    ...
    ma.prototype = {
      ...
      init: function(a, b, c, d, e, f) {
        ...
        g = d.element;
        a.appendChild(g);
        a.innerHTML.indexOf("xmlns") === -1 && L(g, "xmlns", Da);
        this.isSVG = !0;
        this.box = g;
        this.boxWrapper = d;
        this.alignedObjects = [];
        this.url = (Ia || fb) && B.getElementsByTagName("base").length ? D.location.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
        this.createElement("desc").add().element.appendChild(B.createTextNode("Created with Highmaps 4.2.4"));
      ...
      buildText: function(a) {
        for (var b = a.element,
            ...
            w = function(a) {
              return m ? z(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : j && j.fontSize || c.style.fontSize || 12, a).h;
            },
            E = function(a) {
              return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">");
            }; t--; )
          b.removeChild(g[t]);
        !f && !p && !q && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(E(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, Q && Q.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), n(e, function(e, f) {
          var g,
              m = 0,
          ...
          n(g, function(e) {
            if (e !== "" || g.length === 1) {
              var p = {},
                  t = B.createElementNS(Da, "tspan"),
                  n;
              h.test(e) && (n = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), L(t, "style", n));
              i.test(e) && !d && (L(t, "onclick", 'location.href="' + e.match(i)[1] + '"'), G(t, {cursor: "pointer"}));
              e = E(e.replace(/<(.|\n)*?>/g, "") || " ");
              if (e !== " ") {
                t.appendChild(B.createTextNode(e));
                if (m)
                  p.dx = 0;
                else if (f && k !== null)
                  p.x = k;
                L(t, p);
                b.appendChild(t);
                !m && f && (!da && d && G(t, {display: "block"}), L(t, "dy", w(t)));
                if (l) {
                  for (var p = e.replace(/([^\^])-/g, "$1- ").split(" "),
                      o = g.length > 1 || f || p.length > 1 && j.whiteSpace !== "nowrap",
                      Q,
                      F,
                      s,
                      r = [],
                      ...
                      u = a.rotation,
                      y = e,
                      A = y.length; (o || q) && (p.length || r.length); )
                    a.rotation = 0, Q = a.getBBox(!0), s = Q.width, !da && c.forExport && (s = c.measureSpanWidth(t.firstChild.data, a.styles)), Q = s > l, F === void 0 && (F = Q), q && F ? (A /= 2, y === "" || !Q && A < 0.5 ? p = [] : (Q && (F = !0), y = e.substring(0, y.length + (Q ? -1 : 1) * ra(A)), p = [y + (l > 3 ? "\u2026" : "")], t.removeChild(t.firstChild))) : !Q || p.length === 1 ? (p = r, r = [], p.length && (x++, t = B.createElementNS(Da, "tspan"), L(t, {
                      dy: v,
                      x: k
                    }), n && L(t, "style", n), b.appendChild(t)), s > l && (l = s)) : (t.removeChild(t.firstChild), r.unshift(p.pop())), p.length && t.appendChild(B.createTextNode(p.join(" ").replace(/- /g, "-")));
                  F && a.attr("title", a.textStr);
                  a.rotation = u;
                }
                m++;
              }
        ...
        }), Q && Q.removeChild(b), p && a.applyTextShadow && a.applyTextShadow(p));
      },
      ...
      button: function(a, b, c, d, e, f, g, h, i) {
        ...
        n = h.style;
        delete h.style;
        H(k.element, va ? "mouseover" : "mouseenter", function() {
          j !== 3 && k.attr(f).css(q);
        });
        H(k.element, va ? "mouseout" : "mouseleave", function() {
          j !== 3 && (l = [e, f, g][j], m = [p, q, t][j], k.attr(l).css(m));
        });
        k.setState = function(a) {
          (k.state = j = a) ? a === 2 ? k.attr(g).css(t) : a === 3 && k.attr(h).css(n) : k.attr(e).css(p);
        };
        ...
        if (i)
          ...
          l = function(a, b) {
            ...
            onload: function() {
              ...
              g.imgCount--;
              if (!g.imgCount && P[g.chartIndex].onload)
                P[g.chartIndex].onload();
            },
            src: j
          }), this.imgCount++);
        return h;
      ...
      label: function(a, b, c, d, e, f, g, h, i) {
        ...
        rb = function() {
          var a,
              b;
          a = l.element.style;
          p = (w === void 0 || E === void 0 || j.styles.textAlign) && s(l.textStr) && l.getBBox();
          j.width = (w || p.width || 0) + 2 * t + o;
          j.height = (E || p.height || 0) + 2 * t;
          B = t + k.fontMetrics(a && a.fontSize, l).b;
          if (C) {
            if (!m)
              a = u, b = (h ? -B : 0) + u, j.box = m = d ? k.symbol(d, a, b, j.width, j.height, ba) : k.rect(a, b, j.width, j.height, 0, ba["stroke-width"]), m.isImg || m.attr("fill", "none"), m.add(j);
            m.isImg || m.attr(r({
              width: y(j.width),
              height: y(j.height)
            }, ba));
        ...
        D = function() {
          var a = j.styles,
              ...
              c;
          c = h ? 0 : B;
          if (s(w) && p && (a === "center" || a === "right"))
            b += {
              center: 0.5,
              right: 1
            }[a] * (w - p.width);
          if (b !== l.x || c !== l.y)
            l.attr("x", b), c !== x && l.attr("y", c);
          l.x = b;
          l.y = c;
        };
        z = function(a, b) {
    ...
    r(K.prototype, {
      ...
      setSpanRotation: function(a, b, c) {
        var d = {},
            e = va ? "-ms-transform" : fb ? "-webkit-transform" : Ia ? "MozTransform" : Fb ? "-o-transform" : "";
    ...
    r(ma.prototype, {html: function(a, b, c) {
        var d = this.createElement("span"),
            ...
            h = function(a, b) {
              n(["opacity", "visibility"], function(c) {
                fa(a, c + "Setter", function(a, c, d, e) {
                  a.call(this, c, d, e);
                  b[d] = c;
                });
              });
    ...
    if (!da && !ka)
      T = {
        init: function(a, b) {
          ...
          c.push(' style="', d.join(""), '"/>');
          if (b)
            c = e || b === "span" || b === "img" ? c.join("") : a.prepVML(c), this.element = ca(c);
          this.renderer = a;
        },
        add: function(a) {
          var b = this.renderer,
        ...
        setSpanRotation: function() {
          var a = this.rotation,
              b = ia(a * ja),
              c = oa(a * ja);
          G(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : "none"});
        },
        ...
        shadow: function(a, b, c) {
          ...
          if (a) {
            ...
            for (e = 1; e <= 3; e++) {
              ...
              h = ca(g.prepVML(k), null, {
                left: z(i.left) + o(a.offsetX, 1),
                top: z(i.top) + o(a.offsetY, 1)
              });
              if (c)
                h.cutOff = l + 1;
              k = ['<stroke color="', a.color || "black", '" opacity="', q * e, '"/>'];
              ca(g.prepVML(k), null, null, h);
      ...
      }, T["stroke-opacitySetter"] = T["fill-opacitySetter"], u.VMLElement = T = aa(K, T), T.prototype.ySetter = T.prototype.widthSetter = T.prototype.heightSetter = T.prototype.xSetter, T = {
        Element: T,
        isIE8: xa.indexOf("MSIE 8.0") > -1,
        init: function(a, b, c, d) {
          var e;
          this.alignedObjects = [];
          d = this.createElement(Ha).css(r(this.getStyle(d), {position: "relative"}));
          e = d.element;
        ...
        color: function(a, b, c, d) {
          ...
          if (i) {
            var j,
                ...
                s = [],
                r = function() {
                  h = ['<fill colors="' + s.join(",") + '" opacity="', t, '" o:opacity2="', q, '" type="', i, '" ', E, 'focus="100%" method="any" />'];
            ...
            F[0] < 1 && a.push([1, F[1]]);
            n(a, function(a, b) {
              g.test(a[1]) ? (f = O(a[1]), j = f.get("rgb"), l = f.get("a")) : (j = a[1], l = 1);
              s.push(a[0] * 100 + "% " + j);
              b ? (t = l, o = j) : (q = l, w = j);
            });
            if (c === "fill")
              if (i === "gradient")
                c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, p = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, E = 'angle="' + (90 - N.atan((m - a) / (p - c)) * 180 / ob) + '"', r();
              else {
                var k = m.r,
                    ba = k * 2,
                    v = k * 2,
                    ...
                    A,
                    k = function() {
                      y && (A = d.getBBox(), x += (y[0] - A.x) / A.width - 0.5, u += (y[1] - A.y) / A.height - 0.5, ba *= y[2] / A.width, v *= y[2] / A.height);
                      E = 'src="' + J.global.VMLRadialGradientURL + '" size="' + ba + "," + v + '" origin="0.5,0.5" position="' + x + "," + u + '" color2="' + w + '" ';
                      r();
                    };
                d.added ? k() : d.onAdd = k;
                k = o;
            ...
            f = O(a), d[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb");
          else {
        ...
        symbols: {
          ...
          rect: function(a, b, c, d, e) {
            return ma.prototype.symbols[!s(e) || !e.r ? "square" : "callout"].call(0, a, b, c, d, e);
          }
        }
      }, u.VMLRenderer = Ya = function() {
        this.init.apply(this, arguments);
      }, Ya.prototype = A(ma.prototype, T), Qa = Ya;
    ...
    var Ib;
    if (ka)
      u.CanVGRenderer = T = function() {
        Da = "http://www.w3.org/1999/xhtml";
      }, T.prototype.symbols = {}, Ib = function() {
        function a() {
          var a = b.length,
              d;
          for (d = 0; d < a; d++)
    ...
    Pa.prototype = {
      addLabel: function() {
        ...
        b = a.labelFormatter.call({
          ...
          value: a.isLog ? qa(a.lin2log(e)) : e
        });
      ...
      handleOverflow: function(a) {
        var b = this.axis,
            ...
            e = o(b.labelRight, v(b.pos + b.len, d - e[1])),
            g = this.label,
            h = this.rotation,
            i = {
              left: 0,
            ...
            q = {};
        if (h)
          h < 0 && c - i * k < f ? p = y(c / ia(h * ja) - f) : h > 0 && c + i * k > e && (p = y((d - c) / ia(h * ja)));
      ...
      getLabelPosition: function(a, b, c, d, e, f, g, h) {
        var i = this.axis,
            ...
            p = e.y;
        s(p) || (p = i.side === 0 ? c.rotation ? -8 : -c.getBBox().height : i.side === 2 ? m.y + 8 : ia(c.rotation * ja) * (m.y - c.getBBox(!1, 0).height / 2));
      ...
      render: function(a, b, c) {
        var d = this.axis,
            ...
            ba = r.x,
            r = r.y,
            v = g && ba === d.pos + d.len || !g && r === d.pos ? -1 : 1,
            c = o(c, 1);
        this.isActive = !0;
        if (q) {
          k = d.getPlotLinePath(k + s, q * v, b, !0);
          if (l === x) {
            l = {
              stroke: t,
              "stroke-width": q
        ...
        if (m)
          d.opposite && (m[0] = -m[0]), h = this.getMarkPath(ba, r, m[0], m[1] * v, g, f), w ? w.animate({
            d: h,
            opacity: c
        ...
        if (i && !isNaN(ba))
          i.xy = r = this.getLabelPosition(ba, r, i, g, j, s, a, E), this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? F = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(r), E && a % E && (F = !1), F && !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr" : "animate"](r), this.isNew = !1) : i.attr("y", -9999);
      },
      destroy: function() {
        cb(this, this.axis);
      }
    };
    var W = u.Axis = function() {
      this.init.apply(this, arguments);
    };
    W.prototype = {
      defaultOptions: {
      ...
      defaultYAxisOptions: {
        ...
        stackLabels: {
          ...
          style: A(Y.line.dataLabels.style, {color: "#000000"})
        }
      },
      ...
      init: function(a, b) {
        ...
        this.crosshair = o(d.crosshair, pa(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
        var f,
      ...
      setOptions: function(a) {
        this.options = A(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], A(J[this.coll], a));
      },
      defaultLabelFormatter: function() {
        ...
        g === x && (g = S(b) >= 1E4 ? u.numberFormat(b, -1) : u.numberFormat(b, -1, x, ""));
        return g;
      },
          ...
          if (c.visible || !b.options.chart.ignoreHiddenSeries) {
            ...
            if (a.isXAxis) {
              if (d = c.xData, d.length)
                a.dataMin = I(o(a.dataMin, d[0]), Ta(d)), a.dataMax = v(o(a.dataMax, d[0]), Ga(d));
            } else {
              c.getExtremes();
              f = c.dataMax;
              c = c.dataMin;
              if (s(c) && s(f))
                a.dataMin = I(o(a.dataMin, c), c), a.dataMax = v(o(a.dataMax, f), f);
              if (s(e))
                a.threshold = e;
      ...
      translate: function(a, b, c, d, e, f) {
        ...
        b ? (a = a * h + i, a -= j, a = a / k + d, e && (a = g.lin2val(a))) : (e && (a = g.val2lin(a)), f === "between" && (f = 0.5), a = h * (a - d) * k + i + h * j + (na(f) ? k * f * g.pointRange : 0));
        return a;
      },
      ...
      getPlotLinePath: function(a, b, c, d, e) {
        ...
        var p = function(a, b, c) {
          ...
          return a;
            ...
            a = c = y(e + i);
        i = k = y(j - e - i);
        isNaN(e) ? m = !0 : this.horiz ? (i = h, k = j - this.bottom, a = c = p(a, g, g + this.width)) : (a = g, c = l - this.right, i = k = p(i, h, h + this.height));
      ...
      getClosest: function() {
        ...
        n(this.series, function(b) {
          ...
          !b.noSharedTooltip && s(c) && (a = s(a) ? I(a, c) : c);
        });
        return a;
      },
      ...
      setTickInterval: function(a) {
        ...
        E = o(b.userMin, d.min);
        F = o(b.userMax, d.max);
        i ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = o(c.min, c.dataMin), b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && U(11, 1)) : (!t && s(q) && (b.dataMin >= q ? (Q = q, j = 0) : b.dataMax <= q && (w = q, k = 0)), b.min = o(E, Q, b.dataMin), b.max = o(F, w, b.dataMax));
        if (e)
          !a && I(b.min, o(b.dataMin, b.min)) <= 0 && U(10, 1), b.min = qa(f(b.min), 15), b.max = qa(f(b.max), 15);
        if (b.range && s(b.max))
          b.userMin = b.min = E = v(b.min, b.minFromRange()), b.userMax = F = b.max, b.range = null;
        b.beforePadding && b.beforePadding();
        b.adjustForMinRange();
        if (!p && !b.axisPointRange && !b.usePercentage && !i && s(b.min) && s(b.max) && (f = b.max - b.min))
          !s(E) && j && (b.min -= f * j), !s(F) && k && (b.max += f * k);
        if (na(d.floor))
          b.min = v(b.min, d.floor);
        if (na(d.ceiling))
          b.max = I(b.max, d.ceiling);
        if (t && s(b.dataMin))
          if (q = q || 0, !s(E) && b.min < q && b.dataMin >= q)
            b.min = q;
          else if (!s(F) && b.max > q && b.dataMax <= q)
            b.max = q;
        b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : i && !l && m === b.linkedParent.options.tickPixelInterval ? l = b.linkedParent.tickInterval : o(l, this.tickAmount ? (b.max - b.min) / v(this.tickAmount - 1, 1) : void 0, p ? 1 : (b.max - b.min) * m / v(b.len, m));
        ...
        if (!l && b.tickInterval < a)
          b.tickInterval = a;
        if (!g && !e && !l)
          b.tickInterval = ub(b.tickInterval, null, N.pow(10, ea(N.log(b.tickInterval) / N.LN10)), o(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
      ...
      getExtremes: function() {
        var a = this.isLog,
            b = this.lin2log;
        return {
          min: a ? qa(b(this.min)) : this.min,
          max: a ? qa(b(this.max)) : this.max,
      ...
      unsquish: function() {
        ...
        b ? (j = !a.staggerLines && !a.step && (s(g) ? [g] : e < o(a.autoRotationLimit, 80) && a.autoRotation)) && n(j, function(a) {
          var b;
          if (a === g || a && a >= -90 && a <= 90)
            i = l(S(h.h / oa(ja * a))), b = i + S(a / 360), b < k && (k = b, f = a, d = i);
        }) : a.step || (d = l(h.h));
        this.autoRotation = j;
      ...
      renderUnsquish: function() {
        ...
        n(c, function(a) {
          var b = (a = d[a]) && a.label;
          if (b)
            b.attr(i), l && b.css(A(l, b.specCss)), delete b.specCss, a.rotation = i.rotation;
        });
      ...
      getOffset: function() {
        ...
        if (!a.axisGroup)
          a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(x), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(x), a.labelGroup = c.g("axis-labels").attr({zIndex: t.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(x);
        if (k || a.isLinked) {
          if (n(e, function(b) {
            f[b] ? f[b].addLabel() : f[b] = new Pa(a, b);
          }), a.renderUnsquish(), t.reserveSpace !== !1 && (h === 0 || h === 2 || {
            1: "left",
            3: "right"
        ...
        if (q && q.text && q.enabled !== !1) {
          ...
          if (j)
            l = a.axisTitle.getBBox()[g ? "height" : "width"], m = q.offset, p = s(m) ? 0 : o(q.margin, g ? 5 : 10);
          a.axisTitle[j ? "show" : "hide"](!0);
        }
        a.offset = F * o(d.offset, E[h]);
        ...
        p = Math.abs(Q) + p;
        Q && (p -= c, p += F * (g ? o(t.y, a.tickRotCorr.y + F * 8) : t.x));
        a.axisTitleMargin = o(m, p);
        E[h] = v(E[h], a.axisTitleMargin + l + F * a.offset, p, k && e.length && ba ? ba[0] : 0);
        d = d.offset ? 0 : ea(d.lineWidth / 2) * 2;
        b[i] = v(b[i], d);
      },
      ...
      render: function() {
        var a = this,
            ...
            t = d.lineWidth,
            o,
            w = b.hasRendered && s(a.oldMin) && !isNaN(a.oldMin),
            E = a.showAxis,
            r = Oa(c.globalAnimation),
            v,
            y;
        ...
        if (a.hasData() || g) {
          a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
            j[b] || (j[b] = new Pa(a, b, "minor"));
            w && j[b].isNew && j[b].render(null, !0);
            j[b].render(null, !1, 1);
          });
          if (h.length && (n(h, function(b, c) {
            if (!g || b >= a.min && b <= a.max)
              k[b] || (k[b] = new Pa(a, b)), w && k[b].isNew && k[b].render(c, !0, 0.1), k[b].render(c);
          }), q && (a.min === 0 || a.single)))
            k[-1] || (k[-1] = new Pa(a, -1, null, !0)), k[-1].render(-1);
          p && n(h, function(c, d) {
            y = h[d + 1] !== x ? h[d + 1] + q : a.max - q;
            if (d % 2 === 0 && c < a.max && y <= a.max + (b.polar ? -q : q))
              l[c] || (l[c] = new u.PlotLineOrBand(a)), v = c + q, l[c].options = {
                from: e ? f(v) : v,
                to: e ? f(y) : y,
                color: p
        ...
        if (t)
          o = a.getLinePath(t), a.axisLine ? a.axisLine.animate({d: o}) : a.axisLine = c.path(o).attr({
            stroke: d.lineColor,
            "stroke-width": t,
            zIndex: 7
          }).add(a.axisGroup), a.axisLine[E ? "show" : "hide"](!0);
        if (i && E)
      ...
      drawCrosshair: function(a, b) {
        var c,
            ...
            e,
            f;
        if (!this.crosshair || (s(b) || !o(d.snap, !0)) === !1)
          this.hideCrosshair();
    ...
    W.prototype.getLogTickPositions = function(a, b, c, d) {
      ...
      if (a >= 0.5)
        ...
        for (var f = ea(b),
          ...
          j = e.length;
          for (k = 0; k < j && !p; k++)
            l = h(g(f) * e[k]), l > b && (!d || m <= c) && m !== x && i.push(m), m > c && (p = !0), m = l;
        }
      else if (b = g(b), c = g(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ub(a, null, N.pow(10, ea(N.log(a) / N.LN10))), i = Fa(this.getLinearTickPositions(a, b, c), h), !d)
    ...
    Jb.prototype = {
      ...
      refresh: function(a, b) {
        ...
        k === !1 ? this.hide() : (this.isHidden && (Ja(d), d.attr("opacity", 1).show()), d.attr({text: k}), l = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: l}), this.updatePosition({
          plotX: f,
          plotY: g,
          negative: a.negative,
          ttBelow: a.ttBelow,
      ...
      getXDateFormat: function(a, b, c) {
        ...
        if (e) {
          ...
          for (f in gb) {
            if (e === gb.week && +Ma("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") {
              f = "week";
              break;
            }
            if (gb[f] > e) {
      ...
      tooltipFooterHeaderFormatter: function(a, b) {
        var c = b ? "footer" : "header",
            ...
            f = e.xDateFormat,
            g = d.xAxis,
            h = g && g.options.type === "datetime" && na(a.key),
            c = e[c + "Format"];
    ...
    var ga;
    Va = B && B.documentElement.ontouchstart !== x;
    ...
    za.prototype = {
      ...
      normalize: function(a, b) {
        ...
        d.pageX === x ? (c = v(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, d = d.pageY - b.top);
        return r(a, {
          chartX: y(c),
          chartY: y(d)
        });
      ...
      runPointActions: function(a) {
        ...
        if (!this._onDocumentMouseMove)
          this._onDocumentMouseMove = function(a) {
            if (P[ga])
              P[ga].pointer.onDocumentMouseMove(a);
          }, H(B, "mousemove", this._onDocumentMouseMove);
        n(e ? l : [o(m[1], f)], function(c) {
          n(b.axes, function(b) {
      ...
      reset: function(a, b) {
        ...
        if (a)
          ...
          g && g.hide(b);
          if (this._onDocumentMouseMove)
            X(B, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
          n(c.axes, function(a) {
            a.hideCrosshair();
          });
      ...
      drag: function(a) {
        ...
        if (!m || !m.touch)
          if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(p - d, 2) + Math.pow(q - e, 2)), this.hasDragged > 10) {
            ...
            if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !t && !m)
      ...
      drop: function(a) {
        ...
        if (c)
          G(c.container, {cursor: c._cursor}), c.cancelClick = this.hasDragged > 10, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = [];
      },
      ...
      setDOMEvents: function() {
        ...
        Wa === 1 && H(B, "mouseup", a.onDocumentMouseUp);
        if (Va)
          b.ontouchstart = function(b) {
            a.onContainerTouchStart(b);
          }, b.ontouchmove = function(b) {
            a.onContainerTouchMove(b);
          }, Wa === 1 && H(B, "touchend", a.onDocumentTouchEnd);
      },
      destroy: function() {
        var a;
        X(this.chart.container, "mouseleave", this.onContainerMouseLeave);
        Wa || (X(B, "mouseup", this.onDocumentMouseUp), X(B, "touchend", this.onDocumentTouchEnd));
        clearInterval(this.tooltipTimeout);
        for (a in this)
          this[a] = null;
      }
    };
    r(u.Pointer.prototype, {
      ...
      pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
        var i = this.chart,
            ...
            y,
            c = function() {
              !r && S(s - x) > 20 && (o = h || S(v - u) / S(s - x));
              t = (p - v) / o + s;
              q = i["plot" + (a ? "Width" : "Height")] / o;
            };
        c();
        b = t;
        b < E.min ? (b = E.min, y = !0) : b + q > E.max && (b = E.max - q, y = !0);
        y ? (v -= 0.8 * (v - g[k][0]), r || (u -= 0.8 * (u - g[k][1])), c()) : g[k] = [v, u];
        n || (f[k] = t - p, f[m] = q);
        f = n ? 1 / o : o;
        e[m] = q;
        e[k] = b;
        d[n ? a ? "scaleY" : "scaleX" : "scale" + j] = o;
        d["translate" + j] = f * p + (v - f * s);
      },
      pinch: function(a) {
        var b = this,
            c = b.chart,
    ...
    if (D.PointerEvent || D.MSPointerEvent) {
      var sa = {},
          ...
          tb = function(a, b, c, d) {
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && P[ga])
              d(a), d = P[ga].pointer, d[b]({
                type: c,
      ...
      r(za.prototype, {
        ...
        onContainerPointerMove: function(a) {
          tb(a, "onContainerTouchMove", "touchmove", function(a) {
            ...
            if (!sa[a.pointerId].target)
              sa[a.pointerId].target = a.currentTarget;
          });
        },
        ...
        batchMSEvents: function(a) {
          ...
          a(B, sb ? "pointerup" : "MSPointerUp", this.onDocumentPointerUp);
        }
      });
      fa(za.prototype, "init", function(a, b, c) {
        a.call(this, b, c);
      ...
      fa(za.prototype, "setDOMEvents", function(a) {
        a.apply(this);
        (this.hasZoom || this.followTouchMove) && this.batchMSEvents(H);
      });
      fa(za.prototype, "destroy", function(a) {
        this.batchMSEvents(X);
        a.call(this);
      });
    }
    var Za = u.Legend = function(a, b) {
      this.init(a, b);
    };
    Za.prototype = {
      init: function(a, b) {
        ...
        this.options = b;
        if (b.enabled)
          c.itemStyle = d, c.itemHiddenStyle = A(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = o(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), c.pages = [], c.render(), H(c.chart, "endResize", function() {
      ...
      setText: function(a) {
        var b = this.options;
        a.legendItem.attr({text: b.labelFormat ? Ca(b.labelFormat, a) : b.labelFormatter.call(a)});
      },
      renderItem: function(a) {
        ...
        if (!n) {
          ...
          a.legendItem = n = c.text("", l ? f + g : -g, this.baseline || 0, r).css(A(a.visible ? h : i)).attr({
            align: l ? "left" : "right",
            zIndex: 2
          }).add(a.legendGroup);
          if (!this.baseline)
          ...
          this.setItemEvents && this.setItemEvents(a, n, r, h, i);
          E && this.createCheckboxForItem(a);
        }
        this.colorizeItem(a, a.visible);
        this.setText(a);
        c = n.getBBox();
        f = a.checkboxOffset = d.itemWidth || a.legendItemWidth || f + g + c.width + j + (E ? 20 : 0);
        this.itemHeight = g = y(a.legendItemHeight || c.height);
        if (e && this.itemX - t + f > (m || b.chartWidth - 2 * k - t - d.x))
          this.itemX = t, this.itemY += q + this.lastLineHeight + p, this.lastLineHeight = 0;
        ...
        this.offsetWidth = m || v((e ? this.itemX - t - j : f) + k, this.offsetWidth);
      },
      getAllItems: function() {
        var a = [];
        n(this.chart.series, function(b) {
          var c = b.options;
          if (o(c.showInLegend, !s(c.linkedTo) ? x : !1, !0))
      ...
      adjustMargins: function(a, b) {
        ...
        this.display && !d.floating && n([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
          f.test(e) && !s(a[g]) && (c[hb[g]] = v(c[hb[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + o(d.margin, 12) + b[g]));
        });
      },
      render: function() {
        var a = this,
      ...
      handleOverflow: function(a) {
        ...
        if (a > f && k.enabled !== !1) {
          ...
          w(c.chartHeight), m.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
        return a;
      },
      scroll: function(a, b) {
        var c = this.pages,
    ...
    (/Trident\/7\.0/.test(xa) || Ia) && fa(Za.prototype, "positionItem", function(a, b) {
      var c = this,
          d = function() {
    ...
    ha.prototype = {
      ...
      initSeries: function(a) {
        ...
        (b = C[a.type || b.type || b.defaultSeriesType]) || U(17, !0);
        b = new b;
        b.init(this, a);
        return b;
      },
      ...
      layOutTitles: function(a) {
        ...
        if (c && (c.css({width: (f.width || h) + "px"}).align(r({y: g.fontMetrics(f.style.fontSize, c).b - 3}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))
          b = c.getBBox().height;
        d && (d.css({width: (e.width || h) + "px"}).align(r({y: b + (f.margin - 13) + g.fontMetrics(e.style.fontSize, c).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = ra(b + d.getBBox().height)));
      ...
      getChartSize: function() {
        ...
        if (!s(b))
          this.containerWidth = la(c, "width");
        if (!s(a))
          this.containerHeight = la(c, "height");
      ...
      cloneRenderTo: function(a) {
        var b = this.renderToClone,
            c = this.container;
        a ? b && (this.renderTo.appendChild(c), Na(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), G(b, {
          position: "absolute",
          top: "-9999px",
          display: "block"
      ...
      getContainer: function() {
        ...
        a || U(13, !0);
        d = z(L(a, "data-highcharts-chart"));
        !isNaN(d) && P[d] && P[d].hasRendered && P[d].destroy();
        ...
        this.renderer = new (u[c.renderer] || Qa)(a, d, e, c.style, c.forExport, b.exporting && b.exporting.allowHTML);
      ...
      reflow: function(a) {
        var b = this,
            c = b.options.chart,
            d = b.renderTo,
            e = c.width || la(d, "width"),
            f = c.height || la(d, "height"),
            c = a ? a.target : D;
        if (!b.hasUserSize && !b.isPrinting && e && f && (c === D || c === B)) {
          if (e !== b.containerWidth || f !== b.containerHeight)
            clearTimeout(b.reflowTimeout), b.reflowTimeout = La(function() {
              if (b.container)
      ...
      setChartSize: function(a) {
        ...
        this.clipBox = {
          x: b,
          y: c,
          width: ea(this.plotSizeX - v(d, h[1]) / 2 - b),
          height: v(0, ea(this.plotSizeY - v(d, h[2]) / 2 - c))
        };
      ...
      drawChartBox: function() {
        ...
        if (j)
          f ? f.animate(r) : this.plotBackground = b.rect(q, n, o, w, 0).attr({fill: j}).add().shadow(a.plotShadow);
        if (l)
          h ? h.animate(r) : this.plotBGImage = b.image(l, q, n, o, w).add();
        s ? s.animate({
          width: v.width,
          height: v.height
        ...
        if (m)
          g ? (g.strokeWidth = -m, g.animate(g.crisp({
            ...
            width: o,
            height: w
          }))) : this.plotBorder = b.rect(q, n, o, w, 0, -m).attr({
      ...
      linkSeries: function() {
        ...
        n(b, function(b) {
          ...
          if (ta(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))
      ...
      render: function() {
        var a = this.axes,
            ...
            g;
        this.setTitle();
        this.legend = new Za(this, c.legend);
      ...
      isReadyToRender: function() {
        var a = this;
        return !da && D == D.top && B.readyState !== "complete" || ka && !D.canvg ? (ka ? Ib.push(function() {
          a.firstRender();
    ...
    Z.prototype = {
      ...
      destroy: function() {
        var a = this.series.chart,
            ...
            c;
        a.pointCount--;
        if (b && (this.setState(), ua(b, this), !b.length))
          a.hoverPoints = null;
    ...
    R.prototype = {
      ...
      init: function(a, b) {
        ...
        c._i = f.length - 1;
        bb(f, g);
        this.yAxis && bb(this.yAxis.series, g);
        n(f, function(a, b) {
          a.index = b;
      ...
      autoIncrement: function() {
        ...
        d && (a = new wa(b), d === "day" ? a = +a[Ab](a[lb]() + c) : d === "month" ? a = +a[Bb](a[mb]() + c) : d === "year" && (a = +a[Cb](a[nb]() + c)), c = a - b);
        this.xIncrement = b + c;
        return b;
      },
      setOptions: function(a) {
        ...
        this.userOptions = a;
        c = A(e, c.series, a);
        this.tooltipOptions = A(J.tooltip, J.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
      ...
      getColor: function() {
        this.options.colorByPoint ? this.options.color = null : this.getCyclic("color", this.options.color || Y[this.type].color, this.chart.options.colors);
      },
      getSymbol: function() {
        ...
        if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
          ...
          if (p && h > p) {
            ...
            if (na(j)) {
              ...
              if (r)
                for (c = 0; c < h; c++)
                  j = a[c], q[c] = j[0], t[c] = j.slice(1, r + 1);
              else
                for (c = 0; c < h; c++)
                  j = a[c], q[c] = j[0], t[c] = j[1];
            else
              U(12);
          } else
            for (c = 0; c < h; c++)
              if (a[c] !== x && (j = {series: e}, e.pointClass.prototype.applyOptions.apply(j, [a[c]]), e.updateParallelArrays(j, c), m && s(j.name)))
                l.names[j.x] = j.name;
          ta(t[0]) && U(14, !0);
          e.data = [];
      ...
      processData: function(a) {
        ...
        for (i = b.length || 1; --i; )
          d = m ? k(b[i]) - k(b[i - 1]) : b[i] - b[i - 1], d > 0 && (g === x || d < g) ? g = d : d < 0 && this.requireSorting && U(15);
        this.cropped = f;
        this.cropStart = e;
      ...
      generatePoints: function() {
        ...
        for (m = 0; m < g; m++)
          i = h + m, k ? (l[m] = (new f).init(this, [d[m]].concat(pa(e[m]))), l[m].dataGroup = this.groupMap[m]) : (b[i] ? j = b[i] : a[i] !== x && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j), l[m].index = i;
        if (b && (g !== (c = b.length) || k))
          for (m = 0; m < c; m++)
            if (m === h && !k && (m += g), b[m])
      ...
      getExtremes: function(a) {
        ...
        d = a.length;
        for (l = 0; l < d; l++)
          if (k = c[l], j = a[l], i = j !== null && j !== x && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k)
            if (i = j.length)
              for (; i--; )
                j[i] !== null && (e[f++] = j[i]);
            else
      ...
      translate: function() {
        ...
        for (var a = this.options,
          ...
          var w = f[a],
              ...
              F = w.y;
          p = w.low;
          var u = b && e.stacks[(this.negStacks && F < (l ? 0 : j) ? "-" : "") + this.stackKey];
          if (e.isLog && F !== null && F <= 0)
            w.y = F = null, U(10);
          w.plotX = m = I(v(-1E5, c.translate(E, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
          if (b && this.visible && !w.isNull && u && u[E])
            n = this.getStackIndicator(n, E, this.index), u = u[E], F = u.points[n.key], p = F[0], F = F[1], p === l && (p = o(j, e.min)), e.isLog && p <= 0 && (p = null), w.total = w.stackTotal = u.total, w.percentage = u.total && w.y / u.total * 100, w.stackY = F, u.setOffset(this.pointXOffset || 0, this.barW || 0);
          w.yBottom = s(p) ? e.translate(p, 0, 1, 0, 1) : null;
          h && (F = this.modifyValue(F, w));
          w.plotY = p = typeof F === "number" && F !== Infinity ? I(v(-1E5, e.translate(F, 0, 1, 0, 1)), 1E5) : x;
          w.isInside = p !== x && p >= 0 && p <= e.len && m >= 0 && m <= c.len;
          w.clientX = k ? c.translate(E, 0, 0, 0, 1) : m;
          w.negative = w.y < (j || 0);
          w.category = d && d[w.x] !== x ? d[w.x] : w.x;
          w.isNull || (q !== void 0 && (r = I(r, S(m - q))), q = m);
        }
        this.closestPointRangePx = r;
      },
      getValidPoints: function(a, b) {
        var c = this.chart;
        return Ra(a || this.points || [], function(a) {
      ...
      drawPoints: function() {
        var a,
            ...
            n,
            s = this.markerGroup,
            w = o(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
        if (l.enabled !== !1 || this._hasPointMarkers)
          for (f = b.length; f--; )
            if (g = b[f], d = ea(g.plotX), e = g.plotY, j = g.graphic, p = g.marker || {}, q = !!g.marker, a = w && p.enabled === x || p.enabled, n = g.isInside, a && e !== x && !isNaN(e) && g.y !== null)
              if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = o(p.symbol, this.symbol), k = i.indexOf("url") === 0, j)
                ...
                if (n && (h > 0 || k))
                  g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? p : l).attr(a).add(s);
              }
            else if (j)
              g.graphic = j.destroy();
      },
      ...
      getAttribs: function() {
        ...
        var t = a.zones,
            v = a.zoneAxis || "y",
            w;
        b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || O(e.color || g).brighten(e.brightness).get(), e.negativeColor = e.negativeColor || O(e.negativeColor || h).brighten(e.brightness).get());
        ...
        if (!j || g < j || k)
          for (; g--; ) {
            ...
            if (t.length) {
              k = 0;
              for (f = t[k]; j[v] >= f.value; )
                f = t[++k];
              j.color = j.fillColor = o(f.color, a.color);
            }
            ...
            if (k) {
              ...
              if (!b.marker || j.negative && !f.fillColor && !e.fillColor)
                f[a.pointAttrToOptions.fill] = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || O(j.color).brighten(f.brightness || e.brightness).get();
              f = {color: j.color};
              if (!q)
                f.fillColor = j.color;
              if (!p)
      ...
      destroy: function() {
        ...
        n(a.axisTypes || [], function(b) {
          if (h = a[b])
            ua(h.series, a), h.isDirty = h.forceRedraw = !0;
        });
      ...
      getGraphPath: function(a, b, c) {
        ...
        n(a, function(g, j) {
          ...
          if ((g.leftCliff || p && p.rightCliff) && !c)
            i = !0;
          g.isNull && !s(b) && j > 0 ? i = !e.connectNulls : g.isNull && !b ? i = !0 : (j === 0 || i ? p = ["M", g.plotX, g.plotY] : d.getPointSpline ? p = d.getPointSpline(a, g, j) : f ? (p = f === 1 ? ["L", p.plotX, m] : f === 2 ? ["L", (p.plotX + l) / 2, p.plotY, "L", (p.plotX + l) / 2, m] : ["L", l, p.plotY], p.push("L", l, m)) : p = ["L", l, m], h.push.apply(h, p), i = !1);
        });
      ...
      applyZones: function() {
        var a = this,
            ...
            E,
            s = !1;
        if (d.length && (i || k) && l.min !== x)
          i && i.hide(), k && k.hide(), m = l.getExtremes(), n(d, function(d, n) {
            e = p ? t ? b.plotWidth : 0 : t ? 0 : l.toPixels(m.min);
            e = I(v(o(f, e), 0), j);
            f = I(v(y(l.toPixels(o(d.value, m.max), !0)), 0), j);
            s && (e = f = l.toPixels(m.max));
            r = Math.abs(e - f);
            w = I(e, f);
            E = v(e, f);
            if (l.isXAxis) {
      ...
      invertGroups: function() {
        ...
        var b = this,
            c = b.chart;
        if (b.xAxis)
          H(c, "resize", a), H(b, "destroy", function() {
            X(c, "resize", a);
          }), a(), b.invertGroups = a;
      },
      ...
      render: function() {
        var a = this,
            ...
            c,
            d = a.options,
            e = !!a.animate && b.renderer.isSVG && Oa(d.animation).duration,
        ...
        e && a.animate();
        if (!h)
          a.animationTimeout = La(function() {
            a.afterAnimate();
          }, e);
      ...
      searchKDTree: function(a, b) {
        function c(a, b, k, j) {
          var l = b.point,
              ...
              n,
              o = l;
          n = s(a[e]) && s(l[e]) ? Math.pow(a[e] - l[e], 2) : null;
          p = s(a[f]) && s(l[f]) ? Math.pow(a[f] - l[f], 2) : null;
          p = (n || 0) + (p || 0);
          l.dist = s(p) ? Math.sqrt(p) : Number.MAX_VALUE;
          l.distX = s(n) ? Math.sqrt(n) : Number.MAX_VALUE;
          m = a[m] - l[m];
          p = m < 0 ? "left" : "right";
          n = m < 0 ? "right" : "left";
    ...
    r(ha.prototype, {
      addSeries: function(a, b, c) {
        var d,
            e = this;
        a && (b = o(b, !0), M(e, "addSeries", {options: a}, function() {
          d = e.initSeries(a);
          e.isDirtyLegend = !0;
          e.linkSeries();
          b && e.redraw(c);
      ...
      showLoading: function(a) {
        ...
        if (!d)
          b.loadingDiv = d = ca(Ha, {className: "highcharts-loading"}, r(e.style, {
            zIndex: 10,
            display: "none"
          }), b.container), b.loadingSpan = ca("span", null, e.labelStyle, d), H(b, "redraw", f);
        b.loadingSpan.innerHTML = a || c.lang.loading;
        if (!b.loadingShown)
          G(d, {
            opacity: 0,
            display: ""
          }), Sa(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
        f();
      },
    ...
    r(Z.prototype, {
      update: function(a, b, c, d) {
        function e() {
          ...
          if (l && f.name)
            l[f.x] = f.name;
          j.data[i] = $(j.data[i]) && !Aa(j.data[i]) ? f.options : a;
      ...
      remove: function(a, b) {
        this.series.removePoint(ya(this, this.series.data), a, b);
      }
    });
    r(R.prototype, {
    ...
    T = aa(R, {
      ...
      getColumnMetrics: function() {
        ...
        b.grouping === !1 ? h = 1 : n(a.chart.series, function(b) {
          ...
          if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
            c.stacking ? (f = b.stackKey, g[f] === x && (g[f] = h++), i = g[f]) : c.grouping !== !1 && (i = h++), b.columnIndex = i;
        });
      ...
      translate: function() {
        ...
        n(a.points, function(c) {
          var d = I(o(c.yBottom, f), 9E4),
              ...
              w,
              s = v(h, d) - r;
          S(s) < g && g && (s = g, w = !e.reversed && !c.negative || e.reversed && c.negative, r = S(r - f) > g ? d - g : f - (w ? g : 0));
          c.barX = n;
          c.pointWidth = i;
          c.tooltipPos = b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - n - t / 2, s] : [n + t / 2, h + e.pos - b.plotTop, s];
          c.shapeType = "rect";
          c.shapeArgs = a.crispCol(n, r, t, s);
        });
      },
      getSymbol: V,
      ...
      drawPoints: function() {
        ...
        n(a.points, function(h) {
          ...
          if (i !== x && !isNaN(i) && h.y !== null)
            f = h.shapeArgs, i = s(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], k ? (Ja(k), k.attr(i).attr(g)[b.pointCount < e ? "animate" : "attr"](A(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
          else if (k)
            h.graphic = k.destroy();
        });
      },
      animate: function(a) {
        var b = this,
            ...
            f = {};
        if (da)
          a ? (f.scaleY = 0.001, a = I(c.pos + c.len, v(c.pos, c.toPixels(d.threshold))), e ? f.translateX = a - c.len : f.translateY = a, b.group.attr(f)) : (f[e ? "translateX" : "translateY"] = c.pos, b.group.animate(f, r(Oa(b.options.animation), {step: function(a, c) {
    ...
    R.prototype.drawDataLabels = function() {
      ...
      if (d.enabled || a._hasPointLabels)
        a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", j && !h ? "hidden" : "visible", d.zIndex || 6), j && (k.attr({opacity: +h}), h || H(a, "afterAnimate", function() {
          a.visible && k.show();
          ...
          if (j && !h)
            ...
            h = d.rotation;
            n = e.getLabelConfig();
            i = d.format ? Ca(d.format, n) : d.formatter.call(n, d);
            ...
            if (j)
              ...
              if (u.color === "contrast")
                y.color = d.inside || d.distance < 0 || b.stacking ? l.getContrast(e.color || a.color) : "#000000";
              if (c)
                y.cursor = c;
              for (v in j)
                j[v] === x && delete j[v];
              j = e.dataLabel = l[h ? "text" : "label"](i, 0, -9999, d.shape, null, null, d.useHTML).attr(j).css(r(u, y)).add(k).shadow(d.shadow);
            }
            j && a.alignDataLabel(e, j, d, null, E);
          }
        });
    };
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
      var f = this.chart,
          ...
          l = c.rotation,
          m = c.align,
          p = this.visible && (a.series.forceDL || f.isInsidePlot(h, y(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)),
          n = o(c.overflow, "justify") === "justify";
      if (p)
        d = r({
          x: g ? f.plotWidth - i : h,
          ...
          width: k.width,
          height: k.height
        }), l ? (n = !1, g = f.renderer.rotCorr(j, l), g = {
          x: d.x + c.x + d.width / 2 + g.x,
          y: d.y + c.y + d.height / 2
        }, b[e ? "attr" : "animate"](g).attr({align: c.align}), h = (l + 720) % 360, h = h > 180 && h < 360, m === "left" ? g.y -= h ? k.height : 0 : m === "center" ? (g.x -= k.width / 2, g.y -= k.height / 2) : m === "right" && (g.x -= k.width, g.y -= h ? 0 : k.height)) : (b.align(c, null, d), g = b.alignAttr), n ? this.justifyDataLabel(b, c, g, k, d, e) : o(c.crop, !0) && (p = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)), c.shape && !l && b.attr({
          anchorX: a.plotX,
          anchorY: a.plotY
        });
      if (!p)
        Ja(b), b.attr({y: -9999}), b.placed = !1;
    };
    ...
    if (C.pie)
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
          ...
          for (D = 2; D--; ) {
            var H = [],
                ...
                K;
            if (L) {
              a.sortByAngle(J, D - 0.5);
              for (z = b = 0; !b && J[z]; )
                b = J[z] && J[z].dataLabel && (J[z].dataLabel.getBBox().height || 21), z++;
              if (m > 0) {
                s = I(t + q + m, d.plotHeight);
                for (z = v(0, t - q - m); z <= s; z += b)
                  H.push(z);
                s = H.length;
                if (L > s) {
                  c = [].concat(J);
                ...
                for (z = 0; z < L; z++) {
                  ...
                  var P,
                      O;
                  for (O = 0; O < s; O++)
                    P = S(H[O] - u[1]), P < c && (c = P, K = O);
                  if (K < z && H[z] !== null)
                    K = z;
                  else
                    for (s < L - z + K && H[z] !== null && (K = s - L + z); H[K] === null; )
                      K++;
                  N.push({
                    i: K,
                    y: H[K]
              ...
              for (z = 0; z < L; z++) {
                ...
                c = u[1];
                if (m > 0) {
                  if (s = N.pop(), K = s.i, B = s.y, c > B && H[K + 1] !== null || c < B && H[K - 1] !== null)
                    B = I(v(0, c), d.plotHeight);
                } else
                  B = c;
                A = e.justify ? p[0] + (D ? -1 : 1) * (q + m) : a.getX(B === t - q - m || B === t + q + m ? c : B, D);
                w._attr = {
                  visibility: C,
                  align: u[6]
                };
                ...
                if (this.options.size === null)
                  s = w.width, A - s < f ? G[3] = v(y(s - A + f), G[3]) : A + s > h - f && (G[1] = v(y(A + s - h + f), G[1])), B - b / 2 < 0 ? G[0] = v(y(-B + b / 2), G[0]) : B + b / 2 > i && (G[2] = v(y(B + b / 2 - i), G[2]));
              }
            }
          }
          if (Ga(G) === 0 || this.verifyDataLabelOverflow(G))
            this.placeDataLabels(), r && g && n(this.points, function(b) {
              k = b.connector;
              u = b.labelPos;
              if ((w = b.dataLabel) && w._pos && b.visible)
                C = w._attr.visibility, A = w.connX, B = w.connY, j = l ? ["M", A + (u[6] === "left" ? 5 : -5), B, "C", A, B, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), B, "L", u[2], u[3], "L", u[4], u[5]], k ? (k.animate({d: j}), k.attr("visibility", C)) : b.connector = k = a.chart.renderer.path(j).attr({
                  "stroke-width": g,
      ...
      }, C.pie.prototype.alignDataLabel = V, C.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
            c = this.options,
            d = c.center,
            e = c.minSize || 80,
    ...
    (function(a) {
      ...
      b.prototype.hideOverlappingLabels = function(a) {
        ...
        for (e = 0; e < b; e++) {
          k = a[e];
          for (d = e + 1; d < b; ++d)
            if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (l = k.alignAttr, m = j.alignAttr, p = k.parentGroup, n = j.parentGroup, o = 2 * (k.box ? 0 : k.padding), l = !(m.x + n.translateX > l.x + p.translateX + (k.width - o) || m.x + n.translateX + (j.width - o) < l.x + p.translateX || m.y + n.translateY > l.y + p.translateY + (k.height - o) || m.y + n.translateY + (j.height - o) < l.y + p.translateY)))
    ...
    fa(W.prototype, "getSeriesExtremes", function(a) {
      var b = this.isXAxis,
          c,
          d,
          e = [],
    ...
    fa(W.prototype, "setAxisTranslation", function(a) {
      var b = this.chart,
          c = b.plotWidth / b.plotHeight,
          b = b.xAxis[0],
          d;
      a.call(this);
      this.coll === "yAxis" && b.transA !== x && n(this.series, function(a) {
    ...
    fa(W.prototype, "render", function(a) {
      a.call(this);
      this.fixTo = null;
    });
    var ab = u.ColorAxis = function() {
      this.isColorAxis = !0;
      this.init.apply(this, arguments);
    };
    r(ab.prototype, W.prototype);
    r(ab.prototype, {
      ...
      init: function(a, b) {
        var c = a.options.legend.layout !== "vertical",
            d;
        d = A(this.defaultColorAxisOptions, {
          side: c ? 2 : 1,
          reversed: !c
        }, b, {
          opposite: !c,
      ...
      initDataClasses: function(a) {
        ...
        n(a.dataClasses, function(a, i) {
          ...
          d.push(a);
          if (!a.color)
            f.dataClassColor === "category" ? (k = c.options.colors, a.color = k[e++], e === k.length && (e = 0)) : a.color = b.tweenColors(O(f.minColor), O(f.maxColor), g < 2 ? 0.5 : i / (g - 1));
        });
      },
      ...
      toColor: function(a, b) {
        ...
        if (f)
          for (h = f.length; h--; ) {
            if (g = f[h], e = g.from, d = g.to, (e === x || a >= e) && (d === x || a <= d)) {
              c = g.color;
              if (b)
                b.dataClass = h;
              break;
      ...
      getOffset: function() {
        ...
        if (a) {
          this.axisParent = a;
          W.prototype.getOffset.call(this);
          if (!this.added)
      ...
      drawCrosshair: function(a, b) {
        var c = b && b.plotX,
            ...
            g = this.len;
        if (b)
          e = this.toPixels(b[b.series.colorKey]), e < f ? e = f - 2 : e > f + g && (e = f + g + 2), b.plotX = e, b.plotY = this.len - e, W.prototype.drawCrosshair.call(this, a, b), b.plotX = c, b.plotY = d, this.cross && this.cross.attr({fill: this.crosshair.color}).add(this.legendGroup);
      },
      getPlotLinePath: function(a, b, c, d, e) {
        return typeof e === "number" ? this.horiz ? ["M", e - 4, this.top - 6, "L", e + 4, this.top - 6, e, this.top, "Z"] : ["M", this.left, e, "L", this.left - 6, e + 6, this.left - 6, e - 6, "Z"] : W.prototype.getPlotLinePath.call(this, a, b, c, d);
      },
      update: function(a, b) {
        var c = this.chart,
            d = c.legend;
        ...
        c.options[this.coll] = A(this.userOptions, a);
        W.prototype.update.call(this, a, b);
      ...
      getDataClassLegendSymbols: function() {
        ...
        c.length || n(this.dataClasses, function(d, i) {
          ...
          g = "";
          j === x ? g = "< " : l === x && (g = "> ");
          j !== x && (g += u.numberFormat(j, e) + f);
          j !== x && l !== x && (g += " - ");
          l !== x && (g += u.numberFormat(l, e) + f);
          c.push(r({
            chart: b,
            name: g,
            options: {},
    ...
    n(["fill", "stroke"], function(a) {
      u.Fx.prototype[a + "Setter"] = function() {
        this.elem.attr(a, ab.prototype.tweenColors(O(this.start), O(this.end), this.pos));
      };
    });
    fa(ha.prototype, "getAxes", function(a) {
      var b = this.options.colorAxis;
      a.call(this);
      this.colorAxis = [];
      b && new ab(this, b);
    });
    fa(Za.prototype, "getAllItems", function(a) {
      var b = [],
    ...
    var Ka = {setVisible: function(a) {
        ...
        ib = B.documentElement.style.vectorEffect !== void 0;
    Y.map = A(Y.scatter, {
      allAreas: !0,
      animation: !1,
      nullColor: "#F8F8F8",
    ...
    var Lb = aa(Z, r({
      ...
      onMouseOver: function(a) {
        ...
        if (this.value !== null)
          Z.prototype.onMouseOver.call(this, a);
        else
      ...
      onMouseOut: function() {
        var a = this,
            b = +new wa,
            c = O(a.color),
            d = O(a.pointAttr.hover.fill),
            e = Oa(a.series.options.states.normal.animation).duration,
            f;
        if (e && c.rgba.length === 4 && d.rgba.length === 4 && a.state !== "select")
          f = a.pointAttr[""].fill, delete a.pointAttr[""].fill, clearTimeout(a.colorInterval), a.colorInterval = setInterval(function() {
            var f = (new wa - b) / e,
                h = a.graphic;
            f > 1 && (f = 1);
            h && h.attr("fill", ab.prototype.tweenColors.call(0, d, c, f));
    ...
    C.map = aa(C.scatter, A(Kb, {
      ...
      getBox: function(a) {
        ...
        n(a || [], function(a) {
          if (a.path) {
            ...
            if (!a._foundBox) {
              for (; i--; )
                typeof h[i] === "number" && !isNaN(h[i]) && (n ? (q = Math.max(q, h[i]), t = Math.min(t, h[i])) : (r = Math.max(r, h[i]), s = Math.min(s, h[i])), n = !n);
              a._midX = t + (q - t) * (a.middleX || v && v["hc-middle-x"] || 0.5);
              a._midY = s + (r - s) * (a.middleY || v && v["hc-middle-y"] || 0.5);
              a._maxX = q;
              a._minX = t;
              a._maxY = r;
              a._minY = s;
              a.labelrank = o(a.labelrank, (q - t) * (r - s));
              a._foundBox = !0;
            }
      ...
      translatePath: function(a) {
        ...
        if (a)
          for (i = a.length; i--; )
            typeof a[i] === "number" ? (k[i] = b ? (a[i] - e) * f + c : (a[i] - g) * h + d, b = !b) : k[i] = a[i];
        return k;
      },
      setData: function(a, b) {
        ...
        if (d) {
          if (d.type === "FeatureCollection") {
            if (d["hc-transform"])
              for (i in this.chart.mapTransforms = k = d["hc-transform"], k)
                if (k.hasOwnProperty(i) && i.rotation)
                  i.cosAngle = Math.cos(i.rotation), i.sinAngle = Math.sin(i.rotation);
            d = u.geojson(d, this.type, this);
          }
          this.mapData = d;
          for (j = 0; j < d.length; j++)
            i = d[j], k = i.properties, i._i = j, e[0] && k && k[e[0]] && (i[e[0]] = k[e[0]]), h[i[e[0]]] = i;
          this.mapMap = h;
          a && e[1] && n(a, function(a) {
            h[a[e[1]]] && g.push(h[a[e[1]]]);
          });
          c.allAreas ? (this.getBox(d), a = a || [], g = "|" + g.map(function(a) {
            return a[e[0]];
          }).join("|") + "|", n(d, function(b) {
            (!e[0] || g.indexOf("|" + b[e[0]] + "|") === -1) && a.push(A(b, {value: null}));
          })) : this.getBox(g);
        }
      ...
      translate: function() {
        ...
        n(a.data, function(e) {
          ...
          if (d)
            e.shapeType = "path", e.shapeArgs = {d: a.translatePath(e.path)}, ib && (e.shapeArgs["vector-effect"] = "non-scaling-stroke");
        });
        a.translateColors();
      },
      drawPoints: function() {
        ...
        a.doFullTranslate() ? (e.hasRendered && a.pointAttrToOptions.fill === "color" && n(a.points, function(a) {
          ...
          a.graphic && (a.name && a.graphic.addClass("highcharts-name-" + a.name.replace(" ", "-").toLowerCase()), a.properties && a.properties["hc-key"] && a.graphic.addClass("highcharts-key-" + a.properties["hc-key"].toLowerCase()), ib || (a.graphic["stroke-widthSetter"] = V));
        }), this.baseTrans = {
        ...
        ib || a.group.element.setAttribute("stroke-width", a.options.borderWidth / (g || 1));
    ...
    (function(a) {
      ...
      b.prototype.hideOverlappingLabels = function(a) {
        ...
        for (e = 0; e < b; e++) {
          k = a[e];
          for (d = e + 1; d < b; ++d)
            if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (l = k.alignAttr, m = j.alignAttr, n = k.parentGroup, o = j.parentGroup, t = 2 * (k.box ? 0 : k.padding), l = !(m.x + o.translateX > l.x + n.translateX + (k.width - t) || m.x + o.translateX + (j.width - t) < l.x + n.translateX || m.y + o.translateY > l.y + n.translateY + (k.height - t) || m.y + o.translateY + (j.height - t) < l.y + n.translateY)))
              (k.labelrank < j.labelrank ? k : j).newOpacity = 0;
        }
        c(a, function(a) {
          var b,
        ...
        if (o(b.enableButtons, b.enabled) && !a.renderer.forExport)
          for (d in a.mapNavButtons = [], c)
            if (c.hasOwnProperty(d))
              f = A(b.buttonOptions, c[d]), e = f.theme, e.style = A(f.theme.style, f.style), g = e.states, e = a.renderer.button(f.text, 0, 0, i, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
                width: f.width,
                height: f.height,
                ...
                width: e.width,
                height: 2 * e.height
              }), null, f.alignTo), H(e.element, "dblclick", h), a.mapNavButtons.push(e);
      },
    ...
    fa(ha.prototype, "render", function(a) {
      var b = this,
          c = b.options.mapNavigation;
      b.renderMapNavigation();
      a.call(b);
      (o(c.enableDoubleClickZoom, c.enabled) || c.enableDoubleClickZoomTo) && H(b.container, "dblclick", function(a) {
        b.pointer.onContainerDblClick(a);
      });
      o(c.enableMouseWheelZoom, c.enabled) && H(b.container, B.onmousewheel === void 0 ? "DOMMouseScroll" : "mousewheel", function(a) {
    ...
    fa(za.prototype, "pinchTranslate", function(a, b, c, d, e, f, g) {
    ...
    Y.mappoint = A(Y.scatter, {dataLabels: {
        enabled: !0,
        formatter: function() {
    ...
    C.mappoint = aa(C.scatter, {
      type: "mappoint",
      forceDL: !0,
      pointClass: aa(Z, {applyOptions: function(a, b) {
          var c = Z.prototype.applyOptions.call(this, a, b);
          a.lat !== void 0 && a.lon !== void 0 && (c = r(c, this.series.chart.fromLatLonToPoint(c)));
          return c;
        }})
    });
    Y.bubble = A(Y.scatter, {
      dataLabels: {
        formatter: function() {
          return this.point.z;
        },
    ...
    C.bubble = aa(C.scatter, {
      ...
      applyOpacity: function(a) {
        ...
        c !== 1 && (a = O(a).setOpacity(c).get("rgba"));
        return a;
      },
      ...
      getRadii: function(a, b, c, d) {
        ...
        for (f = 0, e = h.length; f < e; f++)
          g = h[f], k.sizeByAbsoluteValue && g !== null && (g = Math.abs(g - l), b = Math.max(b - l, Math.abs(a - l)), a = 0), g === null ? g = null : g < a ? g = c / 2 - 1 : (g = m > 0 ? (g - a) / m : 0.5, j && g >= 0 && (g = Math.sqrt(g)), g = N.ceil(c + g * (d - c)) / 2), i.push(g);
        this.radii = i;
      },
      animate: function(a) {
        var b = this.options.animation;
      ...
      translate: function() {
        ...
        for (a = b.length; a--; )
          c = b[a], d = e ? e[a] : 0, typeof d === "number" && d >= this.minPxSize / 2 ? (c.shapeType = "circle", c.shapeArgs = {
            x: c.plotX,
            y: c.plotY,
            r: d
          }, c.dlBox = {
    ...
    W.prototype.beforePadding = function() {
      var a = this,
          ...
          h = this.min,
          i = {},
          k = N.min(c.plotWidth, c.plotHeight),
          j = Number.MAX_VALUE,
          l = -Number.MAX_VALUE,
          m = this.max - h,
          p = b / m,
          ...
          if (a.allowZoomOutside = !0, q.push(b), f)
            n(["minSize", "maxSize"], function(a) {
              var b = d[a],
                  ...
                  b = z(b);
              i[a] = c ? k * b / 100 : b;
            }), b.minPxSize = i.minSize, b.maxPxSize = i.maxSize, b = b.zData, b.length && (j = o(d.zMin, N.min(j, N.max(Ta(b), d.displayNegative === !1 ? d.zThreshold : -Number.MAX_VALUE))), l = o(d.zMax, N.max(l, Ga(b))));
      });
      n(q, function(b) {
        var c = b[g],
            i = c.length,
        ...
        if (m > 0)
          for (; i--; )
            typeof c[i] === "number" && a.dataMin <= c[i] && c[i] <= a.dataMax && (k = b.radii[i], d = Math.min((c[i] - h) * p - k, d), e = Math.max((c[i] - h) * p + k, e));
      });
      q.length && m > 0 && !this.isLog && (e -= b, p *= (b + d - e) / b, n([["min", "userMin", d], ["max", "userMax", e]], function(b) {
        o(a.options[b[0]], a[b[1]]) === x && (a[b[0]] += b[2] / p);
      }));
    };
    if (C.bubble)
      Y.mapbubble = A(Y.bubble, {
        animationLimit: 500,
        tooltip: {pointFormat: "{point.name}: {point.z}"}
      }), C.mapbubble = aa(C.bubble, {
        pointClass: aa(Z, {
          applyOptions: function(a, b) {
            var c;
            a && a.lat !== void 0 && a.lon !== void 0 ? (c = Z.prototype.applyOptions.call(this, a, b), c = r(c, this.series.chart.fromLatLonToPoint(c))) : c = Lb.prototype.applyOptions.call(this, a, b);
            return c;
          },
          ttBelow: !1
        }),
    ...
    u.geojson = function(a, b, c) {
      ...
      if (c && a.copyrightShort)
        c.chart.mapCredits = Ca(c.chart.options.credits.mapText, {geojson: a}), c.chart.mapCreditsFull = Ca(c.chart.options.credits.mapTextFull, {geojson: a});
      return d;
    };
    fa(ha.prototype, "showCredits", function(a, b) {
      if (this.mapCredits)
        b.href = null;
      a.call(this, u.merge(b, {text: b.text + (this.mapCredits || "")}));
    ...
    u.maps = {};
    ma.prototype.symbols.topbutton = function(a, b, c, d, e) {
      return Eb(a - 1, b - 1, c, d, e.r, e.r, 0, 0);
    };
    ma.prototype.symbols.bottombutton = function(a, b, c, d, e) {
      return Eb(a - 1, b - 1, c, d, 0, 0, e.r, e.r);
    };
    Qa === Ya && n(["topbutton", "bottombutton"], function(a) {
      Ya.prototype.symbols[a] = ma.prototype.symbols[a];
    });
    u.Map = u.mapChart = function(a, b, c) {
    ...
    J.plotOptions.heatmap = A(J.plotOptions.scatter, {
      animation: !1,
      borderWidth: 0,
      nullColor: "#F8F8F8",
      dataLabels: {
    ...
    if (C.column)
      T.prototype.drawTracker = Ka.drawTrackerPoint;
    if (C.pie)
      C.pie.prototype.drawTracker = Ka.drawTrackerPoint;
    if (C.scatter)
      Xa.prototype.drawTracker = Ka.drawTrackerPoint;
    r(Za.prototype, {
      ...
      pan: function(a, b) {
        ...
        n(b === "xy" ? [1, 0] : [1], function(b) {
          var b = c[b ? "xAxis" : "yAxis"][0],
              ...
              i = i > h;
          if (b.series.length && (i || l > I(j.dataMin, j.min)) && (!i || k < v(j.dataMax, j.max)))
    ...
    r(Z.prototype, {
      select: function(a, b) {
        ...
        c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function() {
          ...
          b || n(e.getSelectedPoints(), function(a) {
            if (a.selected && a !== c)
              a.selected = a.options.selected = !1, d.options.data[ya(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect");
          });
        });
      },
      ...
      setState: function(a, b) {
        ...
        if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
          if (this.graphic)
            g = g && this.graphic.symbolName && o.r, this.graphic.attr(A(o, g ? {
              x: c - g,
              y: d - g,
              width: 2 * g,
              height: 2 * g
    ...
    r(R.prototype, {
      ...
      drawTracker: Ka.drawTrackerGraph
    });
    r(u, {
      Color: O,
      Point: Z,
