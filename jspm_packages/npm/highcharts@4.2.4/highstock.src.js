        ...
        if (e.touches.length === 1) {
          ...
          if (chart.isInsidePlot(e.chartX - chart.plotLeft, e.chartY - chart.plotTop) && !chart.openMenu) {
            ...
            if (e.type === 'touchmove') {
              ...
              hasMoved = Math.sqrt(Math.pow(pinchDown[0].chartX - e.chartX, 2) + Math.pow(pinchDown[0].chartY - e.chartY, 2)) >= 4;
            }
    ...
    Series.prototype = {
      ...
      updateParallelArrays: function(point, i) {
        var series = point.series,
            args = arguments,
            fn = typeof i === 'number' ? function(key) {
      ...
      translate: function() {
        ...
        for (i = 0; i < dataLength; i++) {
          ...
          point.plotX = plotX = mathMin(mathMax(-1e5, xAxis.translate(xValue, 0, 0, 0, 1, pointPlacement, this.type === 'flags')), 1e5);
        ...
        if (hasSVG) {
          if (init) {
            ...
            series.group.animate(attr, extend(animObject(series.options.animation), {step: function(val, fx) {
                series.group.attr({scaleY: fx.pos});
              }}));
            series.animate = null;
          }
        }
    ...
    Series.prototype.alignDataLabel = function(point, dataLabel, options, alignTo, isNew) {
      ...
      if (visible) {
        ...
        if (rotation) {
          ...
          dataLabel[isNew ? 'attr' : 'animate'](alignAttr).attr({align: options.align});
    ...
    Scroller.prototype = {
      ...
      render: function(min, max, pxMin, pxMax) {
        var scroller = this,
            ...
            verb,
            unionExtremes;
        if (!defined(min) || isNaN(min) || !defined(max) || isNaN(max) || (scroller.hasDragged && !defined(pxMin))) {
          return;
        }
      ...
      getUnionExtremes: function(returnFalseOnNoBaseSeries) {
        ...
        if (!returnFalseOnNoBaseSeries || baseAxis.dataMin !== null) {
          ret = {
            dataMin: pick(navAxisOptions && navAxisOptions.min, numExt('min', baseAxisOptions.min, baseAxis.dataMin, navAxis.dataMin)),
            dataMax: pick(navAxisOptions && navAxisOptions.max, numExt('max', baseAxisOptions.max, baseAxis.dataMax, navAxis.dataMax))
          };
        }
        return ret;
      },
