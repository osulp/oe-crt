...
(function(process) {
  (function(C, Z) {
      ...
      for (var c = "{",
        ...
        if (d) {
          ...
          for (h = 0; h < i; h++)
            e = e[g[h]];
          if (f.length)
            f = f.join(":"), g = /\.([0-9])/, h = S.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = w.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Pa(f, e);
        }
        k.push(e);
        a = a.slice(c + 1);
        c = (d = !d) ? "}" : "{";
    ...
    ka = function(a, b) {
      var c;
      if (b === "width")
        return Math.min(a.offsetWidth, a.scrollWidth) - ka(a, "padding-left") - ka(a, "padding-right");
      else if (b === "height")
        return Math.min(a.offsetHeight, a.scrollHeight) - ka(a, "padding-top") - ka(a, "padding-bottom");
    ...
    V = function(a, b, c) {
      ...
      var f,
          ...
          h;
      if (g)
        b ? (f = g[b] || [], c ? (h = ra(c, f), h > -1 && (f.splice(h, 1), g[b] = f), d(b, c)) : (e(), g[b] = [])) : (e(), a.hcEvents = {});
    };
    H = function(a, b, c, d) {
      var e;
      e = a.hcEvents;
      ...
      if (A.createEvent && (a.dispatchEvent || a.fireEvent))
        e = A.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, s(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e);
      else if (e) {
        e = e[b] || [];
        f = e.length;
        if (!c.preventDefault)
    ...
    Wa = function(a, b, c) {
      ...
      c.curAnim = D(b);
      for (h in b)
        g = new qb(a, c, h), f = null, h === "d" ? (g.paths = g.initPath(a, a.d, b.d), g.toD = b.d, d = 0, f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(ka(a, h)) || 0, h !== "opacity" && (e = "px")), f || (f = b[h]), f.match && f.match("px") && (f = f.replace(/px/g, "")), g.run(d, f, e);
    };
    if (C.jQuery)
      C.jQuery.fn.highcharts = function() {
        var a = [].slice.call(arguments);
        if (this[0])
          return a[0] ? (new (w[xa(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : O[K(this[0], "data-highcharts-chart")];
      };
      ...
      colorGradient: function(a, b, c) {
        ...
        if (f) {
          ...
          for (q in j)
            v.push(j[q]);
          v = v.join(",");
          i[v] ? n = i[v].attr("id") : (g.id = n = "highcharts-" + zb++, i[v] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [], o(j, function(a) {
        ...
        if (!c) {
          ...
          if (d.isSVG) {
            ...
            if (ya && i && i.fontSize === "11px" && e.toPrecision(3) === "16.9")
              c.height = e = 14;
            if (f)
              c.width = Q(e * aa(g)) + Q(d * U(g)), c.height = Q(e * U(g)) + Q(d * aa(g));
          }
          if (q) {
            for (; n.length > 250; )
              delete m[n.shift()];
      ...
      zIndexSetter: function(a, b) {
        ...
        if (e) {
          ...
          for (i = 0; i < d.length && !h; i++)
            if (e = d[i], f = e.zIndex, e !== g && (F(f) > a || !r(a) && r(f)))
    ...
    P.prototype["stroke-widthSetter"] = P.prototype.strokeSetter = function(a, b, c) {
      ...
      if (this.stroke && this["stroke-width"])
        this.strokeWidth = this["stroke-width"], P.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
    ...
    Ca.prototype = {
      ...
      buildText: function(a) {
        for (var b = a.element,
          ...
          b.removeChild(g[v]);
        !f && !n && !q && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, y && y.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e, function(e, f) {
          var g,
              m = 0,
              ...
              if (e !== " ") {
                ...
                if (l) {
                  for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "),
                      p = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap",
                      o,
                      u,
                      r,
                      t = [],
                      ...
                      z = a.rotation,
                      w = e,
                      D = w.length; (p || q) && (n.length || t.length); )
                    a.rotation = 0, o = a.getBBox(!0), r = o.width, !ca && c.forExport && (r = c.measureSpanWidth(v.firstChild.data, a.styles)), o = r > l, u === void 0 && (u = o), q && u ? (D /= 2, w === "" || !o && D < 0.5 ? n = [] : (o && (u = !0), w = e.substring(0, w.length + (o ? -1 : 1) * ua(D)), n = [w + (l > 3 ? "\u2026" : "")], v.removeChild(v.firstChild))) : !o || n.length === 1 ? (n = t, t = [], n.length && (B++, v = A.createElementNS(Ga, "tspan"), K(v, {
                      dy: s,
                      x: k
      ...
      button: function(a, b, c, d, e, f, g, h, i) {
        ...
        k.setState = function(a) {
          (k.state = j = a) ? a === 2 ? k.attr(g).css(v) : a === 3 && k.attr(h).css(y) : k.attr(e).css(n);
        };
      ...
      label: function(a, b, c, d, e, f, g, h, i) {
        ...
        J = function() {
          ...
          if (A) {
            if (!m)
              a = ob, b = (h ? -w : 0) + ob, j.box = m = d ? k.symbol(d, a, b, j.width, j.height, Y) : k.rect(a, b, j.width, j.height, 0, Y["stroke-width"]), m.isImg || m.attr("fill", "none"), m.add(j);
            m.isImg || m.attr(s({
              width: B(j.width),
              height: B(j.height)
            }, Y));
    ...
    s(Ca.prototype, {html: function(a, b, c) {
      ...
      var Bb = {
        ...
        color: function(a, b, c, d) {
          ...
          if (i) {
            ...
            if (c === "fill")
              if (i === "gradient")
                c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / qa) + '"', t();
              else {
                var k = m.r,
                    Y = k * 2,
                    s = k * 2,
            ...
            f = ja(a), d[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb");
          else {
    ...
    Va.prototype = {
      ...
      handleOverflow: function(a) {
        var b = this.axis,
            ...
            q = {};
        if (h)
          h < 0 && c - i * k < f ? n = B(c / U(h * ha) - f) : h > 0 && c + i * k > e && (n = B((d - c) / U(h * ha)));
        else if (d = c + (1 - i) * k, c - i * k < f ? l = a.x + l * (1 - i) - f : d > e && (l = e - a.x + l * i, m = -1), l = E(j, l), l < j && b.labelAlign === "center" && (a.x += m * (j - l - i * (j - E(k, l)))), k > l || b.autoRotation && g.styles.width)
          n = l;
        if (n) {
          q.width = n;
      ...
      render: function(a, b, c) {
        ...
        if (m)
          d.opposite && (m[0] = -m[0]), h = this.getMarkPath(Y, t, m[0], m[1] * s, g, f), o ? o.animate({
            d: h,
            opacity: c
        ...
        if (i && !isNaN(Y))
          i.xy = t = this.getLabelPosition(Y, t, i, g, j, r, a, x), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? u = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(t), x && a % x && (u = !1), u && !isNaN(t.y) ? (t.opacity = c, i[this.isNew ? "attr" : "animate"](t), this.isNew = !1) : i.attr("y", -9999);
      },
      destroy: function() {
        Ra(this, this.axis);
      }
    ...
    fa.prototype = {
      ...
      defaultLabelFormatter: function() {
        ...
        if (h)
          ...
          for (; f-- && g === z; )
            c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = w.numberFormat(b / c, -1) + e[f]);
          ...
          if (c.visible || !b.options.chart.ignoreHiddenSeries) {
            ...
            if (a.isXAxis) {
              if (d = c.xData, d.length)
                a.dataMin = E(p(a.dataMin, d[0]), Qa(d)), a.dataMax = t(p(a.dataMax, d[0]), Fa(d));
            } else {
              c.getExtremes();
              f = c.dataMax;
              c = c.dataMin;
              if (r(c) && r(f))
                a.dataMin = E(p(a.dataMin, c), c), a.dataMax = t(p(a.dataMax, f), f);
              if (r(e))
                a.threshold = e;
      ...
      setTickInterval: function(a) {
        ...
        if (e)
          !a && E(b.min, p(b.dataMin, b.min)) <= 0 && Z(10, 1), b.min = da(f(b.min), 15), b.max = da(f(b.max), 15);
        if (b.range && r(b.max))
      ...
      unsquish: function() {
        ...
        b ? (j = !a.staggerLines && !a.step && (r(g) ? [g] : e < p(a.autoRotationLimit, 80) && a.autoRotation)) && o(j, function(a) {
          var b;
          if (a === g || a && a >= -90 && a <= 90)
            i = l(Q(h.h / aa(ha * a))), b = i + Q(a / 360), b < k && (k = b, f = a, d = i);
        }) : a.step || (d = l(h.h));
        this.autoRotation = j;
      ...
      getOffset: function() {
        ...
        if (!a.axisGroup)
          a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(z), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(z), a.labelGroup = c.g("axis-labels").attr({zIndex: v.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(z);
        if (k || a.isLinked) {
          if (o(e, function(b) {
        ...
        if (q && q.text && q.enabled !== !1) {
          ...
          if (j)
            l = a.axisTitle.getBBox()[g ? "height" : "width"], m = q.offset, n = r(m) ? 0 : p(q.margin, g ? 5 : 10);
      ...
      render: function() {
        ...
        if (a.hasData() || g) {
          ...
          if (h.length && (o(h, function(b, c) {
            if (!g || b >= a.min && b <= a.max)
              k[b] || (k[b] = new Va(a, b)), sa && k[b].isNew && k[b].render(c, !0, 0.1), k[b].render(c);
          }), q && (a.min === 0 || a.single)))
        ...
        if (v)
          p = a.getLinePath(v), a.axisLine ? a.axisLine.animate({d: p}) : a.axisLine = c.path(p).attr({
            stroke: d.lineColor,
            "stroke-width": v,
            zIndex: 7
      ...
      drawCrosshair: function(a, b) {
        ...
        if (!this.crosshair || (r(b) || !p(d.snap, !0)) === !1)
          this.hideCrosshair();
        else if (p(d.snap, !0) ? r(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)
          this.hideCrosshair();
    ...
    fa.prototype.getTimeTicks = function(a, b, c, d) {
      ...
      if (r(b)) {
        ...
        for (var d = i.getTime(),
            ...
            m = i[Ua](),
            n = !g || !!Za,
            q = (G.day + (g ? Ya(i) : i.getTimezoneOffset() * 6E4)) % G.day; d < c; )
          e.push(d), k === G.year ? d = jb(h + b * j, 0) : k === G.month ? d = jb(h, l + b * j) : n && (k === G.day || k === G.week) ? d = jb(h, l, m + b * j * (k === G.day ? 1 : 7)) : d += k * j, b++;
        e.push(d);
        o(Ma(e, function(a) {
    ...
    fa.prototype.getLogTickPositions = function(a, b, c, d) {
      ...
      if (a >= 0.5)
        ...
        for (var f = T(b),
          ...
          j = e.length;
          for (k = 0; k < j && !n; k++)
            l = h(g(f) * e[k]), l > b && (!d || m <= c) && m !== z && i.push(m), m > c && (n = !0), m = l;
        }
      else if (b = g(b), c = g(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = tb(a, null, sb(a)), i = Ba(this.getLinearTickPositions(a, b, c), h), !d)
    ...
    Ob.prototype = {
      ...
      refresh: function(a, b) {
        ...
        k === !1 ? this.hide() : (this.isHidden && (Na(d), d.attr("opacity", 1).show()), d.attr({text: k}), l = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: l}), this.updatePosition({
          plotX: f,
          plotY: g,
          negative: a.negative,
          ttBelow: a.ttBelow,
    ...
    Xa.prototype = {
      init: function(a, b) {
        ...
        if (w.Tooltip && b.tooltip.enabled)
          a.tooltip = new Ob(a, b.tooltip), this.followTouchMove = p(b.tooltip.followTouchMove, !0);
        this.setDOMEvents();
      },
      ...
      drag: function(a) {
        ...
        if (!m || !m.touch)
          if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(q - e, 2)), this.hasDragged > 10) {
            ...
            if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !v && !m)
      ...
      drop: function(a) {
        ...
        if (c)
          L(c.container, {cursor: c._cursor}), c.cancelClick = this.hasDragged > 10, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = [];
      },
    ...
    if (C.PointerEvent || C.MSPointerEvent) {
      var va = {},
          ...
          Db = function(a, b, c, d) {
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && O[ga])
    ...
    pb.prototype = {
      init: function(a, b) {
        ...
        this.options = b;
        if (b.enabled)
          c.itemStyle = d, c.itemHiddenStyle = D(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), N(c.chart, "endResize", function() {
      ...
      renderItem: function(a) {
        ...
        if (!o) {
          ...
          if (!this.baseline)
            this.fontMetrics = c.fontMetrics(h.fontSize, o), this.baseline = this.fontMetrics.f + 3 + q, o.attr("y", this.baseline);
    ...
    gb.prototype = {
      ...
      layOutTitles: function(a) {
        ...
        if (c && (c.css({width: (f.width || h) + "px"}).align(s({y: g.fontMetrics(f.style.fontSize, c).b - 3}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))
          b = c.getBBox().height;
      ...
      drawChartBox: function() {
        ...
        if (j)
          f ? f.animate(x) : this.plotBackground = b.rect(q, p, o, r, 0).attr({fill: j}).add().shadow(a.plotShadow);
        if (l)
    ...
    R.prototype = {
      ...
      setData: function(a, b, c, d) {
        ...
        if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
          ...
          if (n && h > n) {
            ...
            for (c = 0; c < h; c++)
              if (a[c] !== z && (j = {series: e}, e.pointClass.prototype.applyOptions.apply(j, [a[c]]), e.updateParallelArrays(j, c), m && r(j.name)))
                l.names[j.x] = j.name;
          xa(v[0]) && Z(14, !0);
          e.data = [];
      ...
      processData: function(a) {
        ...
        for (i = b.length || 1; --i; )
          d = m ? k(b[i]) - k(b[i - 1]) : b[i] - b[i - 1], d > 0 && (g === z || d < g) ? g = d : d < 0 && this.requireSorting && Z(15);
        this.cropped = f;
        this.cropStart = e;
      ...
      generatePoints: function() {
        ...
        for (m = 0; m < g; m++)
          i = h + m, k ? (l[m] = (new f).init(this, [d[m]].concat(ta(e[m]))), l[m].dataGroup = this.groupMap[m]) : (b[i] ? j = b[i] : a[i] !== z && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j), l[m].index = i;
        if (b && (g !== (c = b.length) || k))
          for (m = 0; m < c; m++)
            if (m === h && !k && (m += g), b[m])
      ...
      translate: function() {
        ...
        for (var a = this.options,
          ...
          if (b && this.visible && !s.isNull && w && w[x])
            o = this.getStackIndicator(o, x, this.index), w = w[x], u = w.points[o.key], n = u[0], u = u[1], n === l && (n = p(j, e.min)), e.isLog && n <= 0 && (n = null), s.total = s.stackTotal = w.total, s.percentage = w.total && s.y / w.total * 100, s.stackY = u, w.setOffset(this.pointXOffset || 0, this.barW || 0);
          ...
          for (f = b.length; f--; )
            if (g = b[f], d = T(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, q = !!g.marker, a = r && n.enabled === z || n.enabled, o = g.isInside, a && e !== z && !isNaN(e) && g.y !== null)
              if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j)
                ...
                if (o && (h > 0 || k))
                  g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? n : l).attr(a).add(y);
              }
            else if (j)
              g.graphic = j.destroy();
      },
          ...
          for (; g--; ) {
            ...
            if (k) {
              ...
              if (!b.marker || j.negative && !f.fillColor && !e.fillColor)
                f[a.pointAttrToOptions.fill] = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || ja(j.color).brighten(f.brightness || e.brightness).get();
              f = {color: j.color};
              if (!q)
                f.fillColor = j.color;
              if (!n)
      ...
      applyZones: function() {
        ...
        if (d.length && (i || k) && l.min !== z)
          i && i.hide(), k && k.hide(), m = l.getExtremes(), o(d, function(d, o) {
    ...
    R.prototype.setStackedPoints = function() {
      if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
        ...
        for (x = 0; x < d; x++) {
          ...
          m[y] || (m[y] = {});
          if (!m[y][u])
            n[y] && n[y][u] ? (m[y][u] = n[y][u], m[y][u].total = null) : m[y][u] = new Jb(l, l.options.stackLabels, o, u, h);
          y = m[y][u];
          if (s !== null)
            y.points[r] = y.points[this.index] = [p(y.cum, g)], y.touched = l.stacksTouched, q.index > 0 && this.singleStacks === !1 && (y.points[r][0] = y.points[this.index + "," + u + ",0"][0]);
      ...
      o([b, "-" + b], function(b) {
        ...
        for (var g = d.length,
          ...
          if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f)
            i = i.total ? 100 / i.total : 0, h[0] = da(h[0] * i), h[1] = da(h[1] * i), a.stackedYData[g] = h[1];
      });
    };
    ...
    s(gb.prototype, {
      ...
      showLoading: function(a) {
        ...
        if (!d)
          b.loadingDiv = d = $(Ka, {className: "highcharts-loading"}, s(e.style, {
            zIndex: 10,
            display: "none"
          ...
          o(b, function(g, i) {
            ...
            if (f[g] && !f[g].isNull)
              a.push(f[g]), o([-1, 1], function(a) {
                ...
                if (n)
                  for (m = h; m >= 0 && m < k; )
                    p = n.points[m], p || (m === h ? f[g][c] = !0 : j[m] && (r = e[g].points[m]) && (d -= r[1] - r[0])), m += l;
    ...
    wa = oa(R, {
      ...
      getColumnMetrics: function() {
        ...
        b.grouping === !1 ? h = 1 : o(a.chart.series, function(b) {
          ...
          if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
            c.stacking ? (f = b.stackKey, g[f] === z && (g[f] = h++), i = g[f]) : c.grouping !== !1 && (i = h++), b.columnIndex = i;
        });
      ...
      drawPoints: function() {
        ...
        o(a.points, function(h) {
          ...
          if (i !== z && !isNaN(i) && h.y !== null)
            f = h.shapeArgs, i = r(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], k ? (Na(k), k.attr(i).attr(g)[b.pointCount < e ? "animate" : "attr"](D(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
          else if (k)
            h.graphic = k.destroy();
        });
      },
      animate: function(a) {
        var b = this,
            ...
            f = {};
        if (ca)
          a ? (f.scaleY = 0.001, a = E(c.pos + c.len, t(c.pos, c.toPixels(d.threshold))), e ? f.translateX = a - c.len : f.translateY = a, b.group.attr(f)) : (f[e ? "translateX" : "translateY"] = c.pos, b.group.animate(f, s($a(b.options.animation), {step: function(a, c) {
        ...
        a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", j && !h ? "hidden" : "visible", d.zIndex || 6), j && (k.attr({opacity: +h}), h || N(a, "afterAnimate", function() {
          ...
          if (j && !h)
            ...
            if (j)
              ...
              if (u.color === "contrast")
                B.color = d.inside || d.distance < 0 || b.stacking ? l.getContrast(e.color || a.color) : "#000000";
              if (c)
                B.cursor = c;
              for (t in j)
                j[t] === z && delete j[t];
            ...
            if (M) {
              ...
              if (m > 0) {
                ...
                for (J = 0; J < M; J++) {
                  ...
                  if (K < J && H[J] !== null)
                    ...
                    for (x < M - J + K && H[J] !== null && (K = x - M + J); H[K] === null; )
                      K++;
                  N.push({
                    i: K,
                    y: H[K]
              ...
              for (J = 0; J < M; J++) {
                ...
                if (this.options.size === null)
                  x = w.width, A - x < f ? G[3] = t(B(x - A + f), G[3]) : A + x > h - f && (G[1] = t(B(A + x - h + f), G[1])), C - b / 2 < 0 ? G[0] = t(B(-C + b / 2), G[0]) : C + b / 2 > i && (G[2] = t(B(C + b / 2 - i), G[2]));
              }
            }
          }
          if (Fa(G) === 0 || this.verifyDataLabelOverflow(G))
            this.placeDataLabels(), s && g && o(this.points, function(b) {
              ...
              if ((w = b.dataLabel) && w._pos && b.visible)
                D = w._attr.visibility, A = w.connX, C = w.connY, j = l ? ["M", A + (u[6] === "left" ? 5 : -5), C, "C", A, C, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), C, "L", u[2], u[3], "L", u[4], u[5]], k ? (k.animate({d: j}), k.attr("visibility", D)) : b.connector = k = a.chart.renderer.path(j).attr({
                  "stroke-width": g,
    ...
    (function(a) {
      ...
      b.prototype.hideOverlappingLabels = function(a) {
        ...
        for (e = 0; e < b; e++) {
          k = a[e];
          for (d = e + 1; d < b; ++d)
            if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (l = k.alignAttr, m = j.alignAttr, n = k.parentGroup, o = j.parentGroup, p = 2 * (k.box ? 0 : k.padding), l = !(m.x + o.translateX > l.x + n.translateX + (k.width - p) || m.x + o.translateX + (j.width - p) < l.x + n.translateX || m.y + o.translateY > l.y + n.translateY + (k.height - p) || m.y + o.translateY + (j.height - p) < l.y + n.translateY)))
      ...
      pan: function(a, b) {
        ...
        o(b === "xy" ? [1, 0] : [1], function(b) {
          var b = c[b ? "xAxis" : "yAxis"][0],
              ...
              i = i > h;
          if (b.series.length && (i || l > E(j.dataMin, j.min)) && (!i || k < t(j.dataMax, j.max)))
      ...
      select: function(a, b) {
        ...
        c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function() {
          ...
          b || o(e.getSelectedPoints(), function(a) {
            if (a.selected && a !== c)
              a.selected = a.options.selected = !1, d.options.data[ra(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect");
          });
        });
      },
