...
(function(process) {
  (function(c) {
    ...
    function y(a, b, d, f, h) {
      for (var h = h || 0,
          f = f || z,
          c = h + f,
          n = !0; n && h < c && h < a.length; )
        n = b(a[h], h), h += 1;
      n && (h < a.length ? setTimeout(function() {
        y(a, b, d, f, h);
      }) : d && d());
    }
    var r = c.win.document,
        Q = function() {},
        R = c.Color,
        k = c.Series,
        e = c.seriesTypes,
    ...
    c.extend(k.prototype, {
      ...
      getContext: function() {
        ...
        this.canvas ? f.clearRect(0, 0, b, d) : (this.canvas = r.createElement("canvas"), this.image = a.renderer.image("", 0, 0, b, d).add(this.group), this.ctx = f = this.canvas.getContext("2d"), a.inverted && l(["moveTo", "lineTo", "rect", "arc"], function(a) {
          j(f, a, h);
        }));
        this.canvas.width = b;
      ...
      renderCanvas: function() {
        var a = this,
            ...
            X = !!a.sampling,
            C,
            D = b.marker && b.marker.radius,
            E = this.cvsDrawPoint,
            F = b.lineWidth ? this.cvsLineTo : !1,
            G = D <= 1 ? this.cvsMarkerSquare : this.cvsMarkerCircle,
            Y = b.enableMouseTracking !== !1,
            H,
            i = b.threshold,
            m = h.getThreshold(i),
            I = typeof i === "number",
            J = m,
            Z = this.fill,
            K = a.pointArrayMap && a.pointArrayMap.join(",") === "low,high",
            L = !!b.stacking,
            $ = a.cropStart || 0,
            i = d.options.loading,
            aa = a.requireSorting,
            ...
            o,
            q,
            ca = a.fillOpacity ? (new R(a.color)).setOpacity(V(b.fillOpacity, 0.75)).get() : a.color,
            O = function() {
              Z ? (c.fillStyle = ca, c.fill()) : (c.strokeStyle = a.color, c.lineWidth = b.lineWidth, c.stroke());
            },
            P = function(a, b, d) {
              e === 0 && c.beginPath();
              M ? c.moveTo(a, b) : E ? E(c, a, b, d, H) : F ? F(c, a, b) : G && G(c, a, b, D);
              e += 1;
              e === 1E3 && (O(), e = 0);
              H = {
                clientX: a,
        ...
        if (l.length > 99999)
          ...
          }), clearTimeout(A), d.showLoading("Drawing..."), d.options.loading = i;
        y(L ? a.data : j || l, function(b, c) {
          var e,
              g,
              j,
              i,
              ...
              n = !0;
          if (!l) {
            N ? (e = b[0], g = b[1]) : (e = b, g = k[c]);
            if (K)
              N && (g = b.slice(1, 3)), i = g[0], g = g[1];
            else if (L)
              e = b.x, g = b.stackY, i = g - b.y;
            j = g === null;
            aa || (n = g >= t && g <= W);
            if (!j && e >= p && e <= r && n)
              if (e = Math.round(f.toPixels(e, !0)), X) {
                if (o === void 0 || e === u) {
                  K || (i = g);
                  if (q === void 0 || g > w)
                    w = g, q = c;
                ...
                e !== u && (o !== void 0 && (g = h.toPixels(w, !0), m = h.toPixels(v, !0), P(e, I ? Math.min(g, J) : g, I ? Math.max(m, J) : m), x(e, g, q), m !== g && x(e, m, o)), o = q = void 0, u = e);
              } else
                g = Math.round(h.toPixels(g, !0)), P(e, g, m), x(e, g, c);
            M = j && !ba;
            c % z === 0 && a.canvasToSVG();
          }
          return !l;
          ...
          if (c)
            s(b.style, {
              ...
              opacity: 0
            }), d.loadingShown = !1, A = setTimeout(function() {
    ...
    j(k.prototype, "destroy", function(a) {
      var b = this,
          c = b.chart;
      if (c.hoverPoints)
        c.hoverPoints = t(c.hoverPoints, function(a) {
          return a.series === b;
        });
